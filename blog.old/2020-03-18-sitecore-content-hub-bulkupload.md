...
![インポートする Excel ファイル](img/2020/03/excelfile2.png "インポートする Excel ファイル")
...
![Excel で一括インポートを実行](img/2020/03/excelimport.gif "Excel で一括インポートを実行")

今回は、Description も一緒にインポートをしたため、以下のようにファイル名、タイトルだけでなく、説明にも文章が入っていることがわかります。

![説明に文章が追加されている](img/2020/03/excelimportresult.png "説明に文章が追加されている")
