...
tags: [Content Hub]
description: Sitecore Content Hub のメールテンプレートの利用して、スクリプトでメールを送信する手順を紹介しています。
image: img/2020/10/forgotpassword.png
slug: 2020/10/10/send-email-using-script
---
...
![スクリプトの登録](img/2020/10/createnewscript.gif "スクリプトの登録")
...
この IMailTemplate に関しては、[Mail template](https://docs.stylelabs.com/content/3.1.x/integrations/sdk-common-documentation/strongly-typed-entities/mail-template.html) のように、namespace としては `Stylelabs.M.Sdk.Contracts.Notifications` を利用します。この namespace で定義されているインターフェイスなどは [Namespace Stylelabs.M.Sdk.Contracts.Notifications](https://docs.stylelabs.com/content/3.1.x/api-reference/sdk/Stylelabs.M.Sdk.Contracts.Notifications.html) で定義されています。
...
![エラーが表示される](img/2020/10/errorclientdoesnotexist.png "エラーが表示される")
...
* [Script Properties](https://docs.stylelabs.com/content/3.4.x/integrations/scripting-api/script-context-variables.html?tabs=tabid-1)
...
![ビルド成功](img/2020/10/emailtemplatebuild.png "ビルド成功")
...
![スクリプトの公開](img/2020/10/scriptbuid.gif "スクリプトの公開")
...
![スクリプト一覧](img/2020/10/demoscriptdisable.png "スクリプト一覧")

まずはスクリプトを選択できるように、有効にします。手順は簡単で、クリック一つです。

![スクリプト一覧](img/2020/10/demoscriptenable.png "スクリプト一覧")

続いて、管理画面のアクションから、新規アクションを作成、今回作成したスクリプトを指定します。

![スクリプト一覧](img/2020/10/createdemoaction.gif "スクリプト一覧")
...
![トリガー基本](img/2020/10/triggerstandard.png "トリガー基本")

条件に関しては、新規にタクソノミーが追加された時、という処理にするため、*M.Tag* を選択、条件は特に設定しません。

![条件](img/2020/10/triggercondision.png "アクション")

そしてアクションの項目に、先ほど作成をしたアクションを指定します。

![条件](img/2020/10/triggeraction.png "アクション")
...
![メール送信デモ](img/2020/10/scriptsendemail.gif "メール送信デモ")
...
* [Notifications Client](https://docs.stylelabs.com/content/3.4.x/integrations/script-common-documentation/clients/notifications-client.html)
* [Mail template](https://docs.stylelabs.com/content/3.1.x/integrations/sdk-common-documentation/strongly-typed-entities/mail-template.html)
* [Namespace Stylelabs.M.Sdk.Contracts.Notifications](https://docs.stylelabs.com/content/3.1.x/api-reference/sdk/Stylelabs.M.Sdk.Contracts.Notifications.html)
* [トリガーとアクション](https://haramizu.com/blog/2020/03/24/sitecore-content-hub-trigger-action)