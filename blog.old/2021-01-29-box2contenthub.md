...
tags: [Content Hub]
description: 今回は Box と Sitecore Content Hub の DAM との連携するサンプルを作成しながら、開発のための基本的な手順を紹介していきます。Box にファイルを配置したものが、自動的に Sitecore Content Hub にアセットとして追加されて、承認待ちのステータスになる様に設定するところまで紹介します。
slug: 2021/01/29/box2contenthub
---
...
![box03](img/2021/01/box03.png "box03")
...
![storage01](img/2021/01/storage01.gif "storage01")
...
![storage02](img/2021/01/storage02.png "storage02")
...
![storage03](img/2021/01/storage03.png "storage03")

これでストレージの準備が完了となります。

![storage04](img/2021/01/storage04.png "storage04")
...
![boxlogicapp1](img/2021/01/boxlogicapp1.png "boxlogicapp1")

今回は**空のロジックアップ**を選択します。すると空っぽのデザイナーの画面になります。

![boxlogicapp2](img/2021/01/boxlogicapp2.png "boxlogicapp2")

### Box と連携させる

まず最初に、Box にファイルが作成された時にトリガーが動く様に設定するため、最初のステップを設定するためにBox で検索をします。

![boxlogicapp3](img/2021/01/boxlogicapp3.png "boxlogicapp3")

Box を選択すると複数のトリガーが表示されます。

![boxlogicapp4](img/2021/01/boxlogicapp4.png "boxlogicapp4")

今回のトリガーは、**ファイルが作成された時（プロパティのみ）**を選択します。すると、以下の様に Box へのログインの画面が表示されます。

![boxlogicapp5](img/2021/01/boxlogicapp5.png "boxlogicapp5")

ログインが完了すると、以下の画面になります。

![boxlogicapp6](img/2021/01/boxlogicapp6.png "boxlogicapp6")

今回は、Box のフォルダとして Box Demo を指定しました。

![boxlogicapp7](img/2021/01/boxlogicapp7.png "boxlogicapp7")
...
![boxlogicapp8](img/2021/01/boxlogicapp8.png "boxlogicapp8")
...
![upload2blob1](img/2021/01/upload2blob1.png "upload2blob1")

アクションから **Blob の作成**を選択します。作成をすると、サブスクリプションで利用可能なストレージが一覧で表示されます。

![upload2blob2](img/2021/01/upload2blob2.png "upload2blob2")

今回はすでに準備している contenthubdemo を選択します。接続名を記入して、作成ボタンを押します。すると次の様なダイアログになります。

![upload2blob3](img/2021/01/upload2blob3.png "upload2blob3")

値を設定している画面は以下の通りです。

![upload2blob4](img/2021/01/upload2blob4.gif "upload2blob4")
...
2. 作成しているトリガーを実行する（3分に一度を待つのは時間がかかるので）
    ![upload2blob5](img/2021/01/upload2blob5.png "upload2blob5")
3. Azure Portal の画面からストレージにファイルが出来上がっているのを確認します
    ![upload2blob6](img/2021/01/upload2blob6.png "upload2blob6")
4. 該当するファイルを確認します
    ![upload2blob7](img/2021/01/upload2blob7.gif "upload2blob7")
...
![upload2dam1](img/2021/01/upload2dam1.png "upload2dam1")

![upload2dam2](img/2021/01/upload2dam2.png "upload2dam2")
...
![upload2dam3](img/2021/01/upload2dam3.png "upload2dam3")

HTTP を指定すると、いくつかのアクションが表示されます。

![upload2dam4](img/2021/01/upload2dam4.png "upload2dam4")

今回は一番上にある普通の HTTP を選択します。するとダイアログが以下の様に変わります。

![upload2dam5](img/2021/01/upload2dam5.png "upload2dam5")

このダイアログで HTTP の処理を入力していきます。方法やヘッダー情報は以下の様にまとめてください。：

![upload2dam6](img/2021/01/upload2dam6.png "upload2dam6")
...
![upload2dam7](img/2021/01/upload2dam7.png "upload2dam6")
...
![upload2dam8](img/2021/01/upload2dam8.png "upload2dam8")
...
![upload2dam9](img/2021/01/upload2dam9.png "upload2dam9")
...
![updatedam1](img/2021/01/updatedam1.png "updatedam1")

データ操作のアクションにある、JSON の解析を選択します。

![updatedam2](img/2021/01/updatedam2.png "updatedam2")

コンテンツには１つ前の HTTP 本文を指定します。また、スキーマに入力する項目は、事前のテスト結果で出てきた JSON のデータをサンプルのペイロードとして入れることで出来上がります。作業の内容は次の様になります。

![updatedam3](img/2021/01/updatedam3.gif "updatedam3")
...
![updatedam4](img/2021/01/updatedam4.png "updatedam4")
...
![box2chdemo](img/2021/01/box2chdemo.gif "box2chdemo")
