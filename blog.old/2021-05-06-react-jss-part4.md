...
tags: [JSS,React]
description: これまでサンプルのアプリケーションを作成して動作確認、という内容を紹介してきました。今回は実際に React のコンポーネントを追加したいと思います。
slug: 2021/05/06/react-sdk-part-4
---
...
![scaffold](img/2021/05/scaffold01.png "scaffold")
...
![scaffold](img/2021/05/scaffold02.png "scaffold")
...
![scaffold](img/2021/05/scaffold03.png "scaffold")
