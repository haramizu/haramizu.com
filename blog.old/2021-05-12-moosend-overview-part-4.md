...
tags: [Moosend]
description: 前回、送信者に関しての設定およびリストの作成まで進めました。今回はリストの作成、送信テストまで進めていきます。
slug: 2021/05/12/moosend-overview-part-4
---

[前回](2021-05-11-moosend-overview-part-3.md)、送信者に関しての設定およびリストの作成まで進めました。今回はリストの作成、送信テストまで進めていきます。
...
![Moosend](img/2021/05/moosendoverview28.png "Moosend")

では早速メールを作成していきましょう。クリックをすると以下の画面に切り替わります。

![Moosend](img/2021/05/moosendoverview29.png "Moosend")
...
![Moosend](img/2021/05/moosendoverview30.png "Moosend")

### リストの選択

**Next** のボタンをクリックするとメーリングリストの一覧が表示されます。

![Moosend](img/2021/05/moosendoverview31.png "Moosend")
...
![Moosend](img/2021/05/moosendoverview32.png "Moosend")
...
![Moosend](img/2021/05/moosendoverview45.png "Moosend")

Send Text のボタンをクリックすると、作成したテンプレートで指定したメールアドレスにテストメールが送信されます。

![Moosend](img/2021/05/moosendoverview46.png "Moosend")
...
![Moosend](img/2021/05/moosendoverview47.png "Moosend")

今回はコンテンツのスパムテストを実行します。Content spam test のタブに切り替えます。タブを切り替えると、さまざまなメールサービスに対しての迷惑メール判定を実行している様子を確認することができます。

![Moosend](img/2021/05/moosendoverview48.png "Moosend")

以下の画面は、SPF の設定がされていない場合に表示されるエラー画面になります。

![Moosend](img/2021/05/moosendoverview49.png "Moosend")
...
![Moosend](img/2021/05/moosendoverview50.png "Moosend")
...
![Moosend](img/2021/05/moosendoverview51.png "Moosend")

今回は変更点はないので、このまま送信するため画面の一番下に配置されている **Send** のボタンをクリックして送信します。画面が切り替わり、送信状況の画面に切り替わります。

![Moosend](img/2021/05/moosendoverview52.png "Moosend")

## 配信後の確認

配信が完了すると、完了メールの送信先に設定しているメールアドレスに送信されます。

![Moosend](img/2021/05/moosendoverview53.png "Moosend")

ダッシュボードを参照しにいくと、チェックリストからレポートの画面に切り替わります。

![Moosend](img/2021/05/moosendoverview54.png "Moosend")
...
![Moosend](img/2021/05/moosendoverview55.png "Moosend")

別のレポートとして Link Performance というレポートがあります。これはどういうリンクがクリックされたのか、がわかる形です。

![Moosend](img/2021/05/moosendoverview56.png "Moosend")

またクリックしている人のロケーションも参照できます。

![Moosend](img/2021/05/moosendoverview57.png "Moosend")
