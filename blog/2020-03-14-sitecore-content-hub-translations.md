...
![言語データの管理](../static/img/blog/2020/03/translations.gif "言語データの管理")
...
![エクスポートの手順](../static/img/blog/2020/03/translationexport.gif "エクスポートの手順")

実際にダウンロードした Excel ファイルを参照すると、以下のようなファイル形式となっています。

![](../static/img/blog/2020/03/exportexcel.gif)
