...
![ページへのアクセス権を付与](img/2020/03/addpagepermission.gif "ページへのアクセス権を付与")

## テストユーザーで検証

もう一度、テストユーザーに切り替えてアセットの詳細ページが参照できるか確認をします。

![もう一度、テストアカウントでアクセス](img/2020/03/impersonate2.gif "もう一度、テストアカウントでアクセス")
