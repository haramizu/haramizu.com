...
![ファイルをアップロード](../static/img/blog/2020/03/imageupload.gif "ファイルをアップロード")
...
![ビデオのアップロード](../static/img/blog/2020/03/videoupload.gif "ビデオのアップロード")
...
![PDF ファイルのアップロード](../static/img/blog/2020/03/pdfupload.gif "PDF ファイルのアップロード")
...
![Office ファイルをアップロード](../static/img/blog/2020/03/officeupload.gif "Office ファイルをアップロード")
...
![各ファイルのプレビュー](../static/img/blog/2020/03/previewfiles.gif "各ファイルのプレビュー")

また PowerPoint のファイルに関しても、プレビューでスライドを参照することも可能です。

![PowerPoint ファイルをプレビュー](../static/img/blog/2020/03/previewpowerpoint.gif "PowerPoint ファイルをプレビュー")
