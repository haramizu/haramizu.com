---
slug: 2020/03/18/sitecore-content-hub-bulkupload
...
tags: [Content Hub]
description: ファイルをドラッグ & ドロップでアップロードするだけでなく、一括でアップロードする方法があります。ここでは、その手順に関して紹介をします。
---
...
![](../static/img/blog/2020/03/urlimport.gif "")
...
![インポートする Excel ファイル](../static/img/blog/2020/03/excelfile2.png "インポートする Excel ファイル")
...
![Excel で一括インポートを実行](../static/img/blog/2020/03/excelimport.gif "Excel で一括インポートを実行")

今回は、Description も一緒にインポートをしたため、以下のようにファイル名、タイトルだけでなく、説明にも文章が入っていることがわかります。

![説明に文章が追加されている](../static/img/blog/2020/03/excelimportresult.png "説明に文章が追加されている")
