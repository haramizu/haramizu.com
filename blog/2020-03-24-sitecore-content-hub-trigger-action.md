...
![トリガー管理画面](../static/img/blog/2020/03/triggerhome.gif "トリガー管理画面")
...
![トリガー作成](../static/img/blog/2020/03/triggercreate-2.gif "トリガー作成")

## アクションとは

何らかの処理を実行したい、という定義をするものがアクションとなります。アクションに関しても、管理画面からアクセスすることができます。

![アクション](../static/img/blog/2020/03/actionhome.gif "アクション")

新規アクションを作成する場合、以下のようなダイアログが表示されます。

![新規アクション](../static/img/blog/2020/03/actioncreate.png "新規アクション")
...
![トリガーのサンプル](../static/img/blog/2020/03/autotagtrigger.png "トリガーのサンプル")

このトリガーが呼び出しをしているアクションは以下のような形で定義をしています。

![アクションの設定](../static/img/blog/2020/03/autotagaction.png "アクションの設定")
