...
![xamppinstall](img/2020/12/xamppinstall.gif "xamppinstall")
...
![ファイルコピー](img/2020/12/copydrupal.png "ファイルコピー")
...
![phpmyadmin](img/2020/12/phpmyadmin.png "phpmyadmin")

メニューに表示されている **データベース** をクリックしてデータベース作成画面に移動します。

![phpmyadmin](img/2020/12/createdatabase.png "phpmyadmin")

今回は drupaldemo という名前のデータベースを作成しました。

![phpmyadmin](img/2020/12/drupaldemo.png "phpmyadmin")

作成すると、左側に drupaldemo のデータベースが表示されていれば、データベースの準備は完了となります。

![phpmyadmin](img/2020/12/drupaldemo2.png "phpmyadmin")
...
![drupal](img/2020/12/drupal4.png "drupal")

クリックをした後しばらくするとインストールが開始します。

![drupal](img/2020/12/drupal5.png "drupal")

インストール後の設定として、サイト環境の設定が表示されます。

![drupal](img/2020/12/drupal6.png "drupal")

ユーザー名、パスワードなど必要な項目を入れることで、設定が完了します。インストール後の環境は以下の通りです。

![drupal](img/2020/12/drupal7.png "drupal")
...
![drupal connector](img/2020/12/drupalconnector1.png "drupal connector")

ファイルを解凍すると、以下の様に 2 つの zip ファイルを見つけることができます。

![drupal connector](img/2020/12/drupalconnector2.png "drupal connector")

例えば、libraries.zip を展開すると以下のように２つのフォルダが含まれていることがわかります。

![drupal connector](img/2020/12/drupalconnector3.png "drupal connector")

このフォルダを、Drupal のインストールされているフォルダにコピーします。

![drupal connector](img/2020/12/drupalconnector4.png "drupal connector")

同様に、modules の中にあるファイルもコピーします。

![drupal connector](img/2020/12/drupalconnector5.png "drupal connector")

モジュールのコピーが終わったあと、Drupal の環境で有効にします。Drupal にログインをして、**機能拡張**を選択、**カスタム** の項目に２つのモジュールが準備されていることを確認します。

![drupal connector](img/2020/12/drupalconnector6.png "drupal connector")

２つの項目をチェックして、ページの下の方にあるインストールをクリックすると、モジュールのインストールが完了します。

![drupal connector](img/2020/12/drupalconnector7.png "drupal connector")
...
![drupal 設定](img/2020/12/drupalsetting1.png "drupal 設定")
...
![drupal 設定](img/2020/12/drupalconfig.gif "drupal 設定")

続いて**開発**の設定にある **MConnector Settings** を開きます。

![drupal 設定](img/2020/12/drupalsetting2.png "drupal 設定") 

設定としては、Sitecore Content Hub のインスタンスと URL を設定する画面が出てきます。

![drupal 設定](img/2020/12/drupalsetting3.png "drupal 設定") 
...
![drupal 設定](img/2020/12/contenthubcors.gif "drupal 設定") 
...
![drupal デモ](img/2020/12/drupalwithchdam.gif "drupal デモ") 
