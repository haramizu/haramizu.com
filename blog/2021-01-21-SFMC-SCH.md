...
tags: [Content Hub]
description: Salesforce Marketing Cloud を利用するために Sitecore Content Hub で管理しているアセットを直接利用できるように接続をする手順を紹介します。
slug: 2021/01/21/SFMC-SCH
---
...
![sch1](img/2021/01/sch1.gif "sch1")
...
![sfmc3](img/2021/01/sch2.gif "sfmc3")
...
![sfmc2](img/2021/01/sfmc2.png "sfmc2")

ダッシュボードにアクセスをしたあと、管理者ユーザーのアイコンからセットアップを選択します。

![sfmc3](img/2021/01/sfmc3.png "sfmc3")
...
![sfmcinch1](img/2021/01/sfmcinch1.png "sfmcinch1")

コンテンツブロックの一番下に、カスタムとして Sitecore Content Hub のアイコンが表示されています。

![sfmcinch2](img/2021/01/sfmcinch2.png "sfmcinch2")

表示されているアイコンを、メール側にドラッグ & ドロップで持っていきます。

![sfmcinch3](img/2021/01/sfmcinch3.gif "sfmcinch3")

続いてブロック一覧の画面が拡張子、Sitecore Content Hub のアセットを選択する画面となります。

![sfmcinch4](img/2021/01/sfmcinch4.png "sfmcinch4")
...
![sfmcinch5](img/2021/01/sfmcinch5.gif "sfmcinch5")
