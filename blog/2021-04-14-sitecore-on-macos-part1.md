...
![vmwarefusion](img/2021/04/vmware01.png "vmwarefusion")
...
![sqlserver](img/2021/04/sqlserv01.png "sqlserver")

CD/DVD を接続をメニューから選択をすると、右下にダイアログが表示されます。

![sqlserver](img/2021/04/sqlserv02.png "sqlserver")

ダイアログをクリックすると、ISO ファイルに含まれている実行ファイルをそのまま実行するかのダイアログが表示されます。

![sqlserver](img/2021/04/sqlserv03.png "sqlserver")
...
![sqlserver](img/2021/04/sqlserv04.png "sqlserver")
...
![sqlserver](img/2021/04/sqlserv05.png "sqlserver")

### サーバの構成

SQL Server エージェント、および SQL Server データベースエンジンのアカウント名を Network Service に変更します。

![sqlserver](img/2021/04/sqlserv06.png "sqlserver")
...
![sqlserver](img/2021/04/sqlserv07.png "sqlserver")
...
![choco](img/2021/04/choco05.png "choco")
...
![choco](img/2021/04/choco06.png "choco")
...
![choco](img/2021/04/choco07.png "choco")
...
* [macOS + VMWare Fusion を組み合わせて Sitecore の環境を整える - その２](2021-04-15-sitecore-on-macos-part2.md)