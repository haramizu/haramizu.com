...
description: 前回は Sitecore をインストールするための環境として、 VMware Fusion で仮想マシンを構築しました。今回は、Sitecore Experience Platform 10.1 をインストール、最終的に macOS からアクセスできるようにします。
slug: 2021/04/15/sitecore-on-macos-part2
---

[前回](2021-04-14-sitecore-on-macos-part1.md) は Sitecore をインストールするための環境として、 VMware Fusion で仮想マシンを構築しました。今回は、Sitecore Experience Platform 10.1 をインストール、最終的に macOS からアクセスできるようにします。
...
![Sitecore](img/2021/04/sia01.png "Sitecore")
...
![Sitecore](img/2021/04/sia02.png "Sitecore")
...
![Sitecore](img/2021/04/sia03.png "Sitecore")

しばらくの間、Sitecore が必要とする Windows のコンポーネント、機能のインストールが進みます。

![Sitecore](img/2021/04/sia04.png "Sitecore")

インストールが完了したところで、一度再起動する必要が出ますので、再起動してください。

![Sitecore](img/2021/04/sia05.png "Sitecore")
...
![Solr](img/2021/04/solr01.png "Solr")

![Solr](img/2021/04/solr02.png "Solr")
...
![Sitecore](img/2021/04/sia06.png "Sitecore")
...
![Sitecore](img/2021/04/sia07.png "Sitecore")

![Sitecore](img/2021/04/sia08.png "Sitecore")
...
![network](img/2021/04/network01.png "network")
...
![network](img/2021/04/network02.png "network")

**Install Command** と入力すると、コマンドラインのパスを追加する項目が表示されます。

![network](img/2021/04/network03.png "network")

選択すると、パスが追加されます。

![network](img/2021/04/network04.png "network")
...
![lang](img/2021/04/lang01.png "lang")

続いて左下にあるサイトコアのロゴをクリックして、Control Panel を開いてください。

![lang](img/2021/04/lang02.png "lang")
...
![lang](img/2021/04/lang03.png "lang")
...
![lang](img/2021/04/lang04.png "lang")

コピーが完了したあと、インスタンスを再起動すると日本語のリソースが適用されます。

![lang](img/2021/04/lang05.png "lang")
...
![lang](img/2021/04/lang08.png "lang")

一度ログアウトして、ログインをすると以下の様に管理画面が日本語になりました。

![lang](img/2021/04/lang09.png "lang")
...
![lang](img/2021/04/lang10.png "lang")
