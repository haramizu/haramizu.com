...
description: Headless SSR の動作に関して紹介をしていきました。これを手元で簡単に利用できるように、3回目としては Docker のコンテナを作成して利用する方法を紹介します。
...
![docker](img/2021/04/docker09.png "docker")

docker のイメージを確認します。

![docker](img/2021/04/docker10.png "docker")
...
![docker](img/2021/04/docker11.png "docker")

このあと、 http://localhost:3000 にアクセスしてページが見えればコンテナが正しく動いていることになります。

![docker](img/2021/04/docker12.png "docker")
...
![docker](img/2021/04/docker13.png "docker")
