...
tags: [JSS,React]
description: 前回の記事でコンポーネントを追加しましたが、今回はそのコンポーネントの項目を追加していきます。
slug: 2021/05/07/react-sdk-part-5
---
...
![CarouselItem](img/2021/05/CarouselItem01.png "CarouselItem")
...
![CarouselItem](img/2021/05/CarouselItem02.png "CarouselItem")
