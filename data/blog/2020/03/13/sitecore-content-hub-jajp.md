...
- [Localization](https://doc.sitecore.com/ch/en/users/42/content-hub/manage--localization.html)

## 言語の追加

Sitecore Content Hub の新しいインスタンスを立ち上げると、以下のように英語のユーザーインターフェイスになっています。

![標準の管理画面](/static/images/2020/03/sitecorecontenthub-default.png '標準の管理画面')

言語の追加に関しては、管理画面で実行することができます。右上にあるアイコンの右から 2 つ目のアイコンをクリックすることで、管理画面に移動することができます。

![管理画面](/static/images/2020/03/manageenglish.png '管理画面')

言語の追加は「Portal Language」のツールになります。アイコンから選択するのもよいですが、上の検索ボックスを利用すると素早く見つけることができます。

![Portal Language を選択](/static/images/2020/03/portal.gif 'Portal Language を選択')

右上にある Portal Language のボタンをクリックして、 ja-JP の定義を追加します。

![ja-JP の追加](/static/images/2020/03/addlang.gif 'ja-JP の追加')
...
![Translation を追加](/static/images/2020/03/translationui.gif 'Translation を追加')

Translation の画面の右上に、Import / Export のボタンがあります。今回は Import をクリックして、Excel のリソースファイルをインポートします。

![言語リソースの追加](/static/images/2020/03/jajpimport.gif '言語リソースの追加')

リソースの追加の実行状況に関しては、ユーザーの Jobs から確認することができます。

![Jobs でインポートの状況を確認する](/static/images/2020/03/importjobs.gif 'Jobs でインポートの状況を確認する')

インポートが完了したあとは、次のステップに進んでください。

![インポートが完了しました](/static/images/2020/03/jobcomplete.gif 'インポートが完了しました')
...
![Clear all を実行](/static/images/2020/03/cacheclear.gif 'Clear all を実行')
...
![言語の切り替え](/static/images/2020/03/changelanguage.gif '言語の切り替え')
