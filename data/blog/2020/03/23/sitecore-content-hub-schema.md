...
![スキーマリスト](/static/images/2020/03/schemalist.gif "スキーマリスト")

M.Asset のスキーマ定義が、DAM のアセット管理で利用されている定義となっています。画面は以下の通りです。

![スキーマの定義](/static/images/2020/03/schemadiffinition.png "スキーマの定義")
...
![](/static/images/2020/03/schemagrouplist.gif "")
...
![メンバーの追加項目](/static/images/2020/03/schemaaddmember.png "メンバーの追加項目")
...
![](/static/images/2020/03/schemaupdate.gif "")

実際にアセットの編集項目を参照しにいくと、「デモ」という項目が追加されていることがわかります。

![](/static/images/2020/03/schemachanged.gif "メンバーの追加項目")
