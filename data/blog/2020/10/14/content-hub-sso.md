...
1. 管理ツール _Manage_ を開きます
2. 設定を確認する _Settings_ を開きます
3. 検索ボックスに _Auth_ と入力すると、PortalConfiguration の項目の下にある Authentication を見つけることができます
4. Authentication を開きます
5. 表示モードを Tree から Text に変更をします
6. `authentication_mode` が _Active_ になっている場合、_Passive_ に変更します
...
idp_entity_id の値を取得するためには、_metadata_location_ の URL にアクセスをして、XML の１行目に記載されている ipd_entity_id を引用する形となります。ここでは以下の値となりました。
...
- [Oauth 2.0](https://docs.stylelabs.com/ja-jp/contenthub/4.0.x/content/user-documentation/administration/security/authentication/oauth2.html)
- [SSO 管理](https://docs.stylelabs.com/ja-jp/contenthub/4.0.x/content/integrations/web-sdk/sso-management.html?rp=true&rv=true)
