...
![スクリプト登録](/static/images/2020/10/publiclinkscriptdialog.png "スクリプト登録")

作成されたスクリプトを開き、ソースコードとなるスクリプトを指定し、ビルドを実行します。ビルドでエラーが出ないのを確認して、スクリプトを公開します。

![スクリプト登録](/static/images/2020/10/publiclinkscript.gif "スクリプト登録")

あとはスクリプトが有効になっているか確認をしてください。

![スクリプトを有効にする](/static/images/2020/10/publiclinkscriptenable.gif "スクリプトを有効にする")
...
![アクションの登録](/static/images/2020/10/publiclinkactiondialog.png "アクションの登録")

まとめると、以下の画像のように進めて行く形となります。

![アクションを作成する](/static/images/2020/10/publiclinkcreateaction.gif "アクションを作成する")
...
![ボタンの配置](/static/images/2020/10/publiclinkaddbutton.gif "ボタンの配置")
...
![動作確認](/static/images/2020/10/publiclinkcreatetest.gif "動作確認")
...
![登録ダイアログ](/static/images/2020/10/publiclinkmassdialog.png "登録ダイアログ")

登録の手順に関しては、次の画像を参考にしてください。

![ボタンの追加](/static/images/2020/10/publiclinkmassbutton.gif "ボタンの追加")
...
![一括処理](/static/images/2020/10/publiclinkmasscreate.gif "一括処理")
