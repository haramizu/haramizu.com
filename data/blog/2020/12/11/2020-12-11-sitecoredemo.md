...
description: Sitecore Experience Platform 10.0 からは Docker のサポートが標準となりました。今回は Sitecore Experience Platform 10.0 を Docker で動かすための手順を紹介します。
slug: 2020/12/11/sitecore10docker
---
...
![サーバーマネージャー](img/2020/12/servermanager.gif "サーバーマネージャー")

Internet Explorer を起動すると、プロテクトモードに関してのダイアログが表示されます。

![ダイアログ](img/2020/12/internetexplorer.png "ダイアログ")
...
![HyperV](img/2020/12/hyperv.gif "HyperV")
...
![Choco インストール](img/2020/12/chocogitvscode.gif "Choco インストール")
...
![Docker Desktop インストール](img/2020/12/dockerdesktop.gif "Docker Desktop インストール")

ログインをすると右下のタスクトレイで docker が起動していることを確認できます。

![Docker アイコン](img/2020/12/dockerdesktop.png "Docker アイコン")

アイコンを右クリックして、Windows コンテナに切り替えてください。

![Windows コンテナに切り替え](img/2020/12/switchwindows.gif "Windows コンテナに切り替え")

次のようにダイアログが表示されるので、切り替えをします。

![Windows コンテナに切り替え](img/2020/12/switchwindows.png "Windows コンテナに切り替え")
...
![SitecoreDockerTools インストール](img/2020/12/sitecoredockertools.gif "SitecoreDockerTools インストール")
...
![ダウンロード](img/2020/12/deploymentpackage.png "ダウンロード")
...
![解凍](img/2020/12/projectfolder.png "解凍")
...
![ライセンス](img/2020/12/license.png "ライセンス")
...
ここには、64文字〜128文字のランダムな文字列を設定する必要があります。これに関しても、ツールを利用すると自動的に設定をします。
...
![.envファイル](img/2020/12/envfile.png ".envファイル")
...
![実行結果](img/2020/12/dockertoollog.png "実行結果")
...
* mkcert.exe のプロパティを開いて、ダイアログの下部に記載されているセキュリティの項目をチェックして利用できる様に許可します
    ![mkcert](img/2020/12/mkcert.png "mkcert")
* mkcert -install を実行、ダイアログで **はい** をクリックします
    ![mkcert](img/2020/12/mkcert2.png "mkcert")
...
![mkcert](img/2020/12/certs.png "mkcert")
...
* [最初のSitecoreインスタンスの実行](https://containers.doc.sitecorejp.net/docs/run-sitecore)
