...
_M.Builtin.Editors_ は以下のようになります。

![usergroup5](/static/images/2021/02/usergroup5.png 'usergroup5')

そして、_M.Builtin.Creators_ には**作成**など、アセットを登録するページに対するアクセス権限がついています。

![usergroup6](/static/images/2021/02/usergroup6.png 'usergroup6')

アセットを登録する人には _M.Builtin.Creators_ を、承認する人には _M.Builtin.Approvers_ を付与してください。
