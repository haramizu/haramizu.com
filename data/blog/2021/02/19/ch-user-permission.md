...
![usergroup1](/static/images/2021/02/usergroup1.png "usergroup1")

今回は、M.Builtin.Readers のユーザーグループを確認します。ユーザーグループの名前の横にある歯車のアイコンをクリックしてください。すると以下のような画面に切り替わります。

![usergroup2](/static/images/2021/02/usergroup2.gif "usergroup2")

上の画像を見ていただくように、さまざまな権限を組み合わせた内容となっています。例えば、ということで１つ目のルールを参照します。

![usergroup3](/static/images/2021/02/usergroup3.png "usergroup3")
...
![usergroup4](/static/images/2021/02/usergroup4.png "usergroup4")
...
![usergroup5](/static/images/2021/02/usergroup5.png "usergroup5")

そして、*M.Builtin.Creators* には**作成**など、アセットを登録するページに対するアクセス権限がついています。

![usergroup6](/static/images/2021/02/usergroup6.png "usergroup6")
...
* [ユーザー グループの管理](https://docs.stylelabs.com/ja-jp/contenthub/4.0.x/content/user-documentation/administration/security/users/user-groups/intro.html)
