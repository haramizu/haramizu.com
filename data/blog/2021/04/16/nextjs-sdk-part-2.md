...
![sitecorejss](/static/images/2021/04/jsssite01.png 'sitecorejss')

3. 上記の画面の場合は API キーのボタンを、画面が異なる場合はツリーにある API Keys を右クリックして新規 API キーを作成します
4. API キーの名前を入力します

![sitecorejss](/static/images/2021/04/jsssite02.png 'sitecorejss')

5. CORS Origins と認められたコントローラーのどちらの項目にも \* を設定してください。

![sitecorejss](/static/images/2021/04/jsssite03.png 'sitecorejss')
...
![sitecorejss](/static/images/2021/04/jsssite04.png 'sitecorejss')

ダイアログで必要な項目をチェックして、パブリッシュを実行します。

![sitecorejss](/static/images/2021/04/jsssite05.png 'sitecorejss')

アイテムの公開が完了した際に、API Key が有効になっているかを確認するために、 https://yourhostname/sitecore/api/layout/render/jss?item=/&sc_apikey={YOUR_API_KEY_ID} と API キーを追加した URL でアクセスをして、JSON のデータが表示されるか確認をしてください。

![sitecorejss](/static/images/2021/04/jsssite06.png 'sitecorejss')
...
![sitecorejss](/static/images/2021/04/jsssite07.png 'sitecorejss')
...
![sitecorejss](/static/images/2021/04/jsssite08.png 'sitecorejss')

App_Config¥Include¥zzz のフォルダを作成し、2 つのファイルを Sitecore の設定フォルダにコピーすると jss deploy config と同じ作業をしたことになります。

![sitecorejss](/static/images/2021/04/jsssite09.png 'sitecorejss')
...
![sitecorejss](/static/images/2021/04/jsssite10.png 'sitecorejss')

インポートが完了すると、以下のように Sitecore のコンテンツツリーにアイテムが表示されます。

![sitecorejss](/static/images/2021/04/jsssite11.png 'sitecorejss')
