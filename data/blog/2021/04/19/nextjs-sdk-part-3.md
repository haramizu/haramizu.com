...
![experienceditor](/static/images/2021/04/experienceditor01.png "experienceditor")

http://localhost:3000 にアクセスしてページが見えているのを確認します。

![experienceditor](/static/images/2021/04/experienceditor02.png "experienceditor")

起動しているのを確認したあと、コンテンツエディターで対象となるアイテムを選択、エクスペリエンスエディターを開いてください。コンソールには Sitecore からのアクセスがきていることがわかります。

![experienceditor](/static/images/2021/04/experienceditor03.png "experienceditor")

しばらくして、エクスペリエンスエディターを開いて、文字に関して編集することが可能となっています。

![experienceditor](/static/images/2021/04/experienceditor04.png "experienceditor")

実際に編集を保存、その後コンテンツエディタを参照しにいくと、更新されていることがわかります。

![experienceditor](/static/images/2021/04/experienceditor05.png "experienceditor")
...
* [Sitecore JSS - Next.js SDK を利用してサンプルサイトを構築 - Part.4](/blog/2021/04/20/nextjs-sdk-part-4)
