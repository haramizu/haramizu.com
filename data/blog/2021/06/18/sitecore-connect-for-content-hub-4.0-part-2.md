---
title: Sitecore Connect for Content Hub 4.0 - CMP 設定編
date: '2021-06-18'
lastmod: '2021-06-18'
...
接続文字列に関しては、Azure Service Bus の共有アクセスポリシーが作成されており、_RootManageSharedAccessKey_ を選択、**プライマリ接続文字列**を選択してください。
