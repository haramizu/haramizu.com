...
Microsoft が提供している AntiForgry のクラスを利用しており、悪意のあるスクリプトによる送信防止がデフォルトでオンになっています。この項目を変更するのは以下のファイルです。以下のファイルの *AntiForgeryEnabled* の項目を *false* に変更してください。
...
* [Walkthrough: Exporting catalog and inventory data](https://doc.sitecore.com/developers/101/sitecore-experience-commerce/en/walkthrough--exporting-catalog-and-inventory-data.html)
