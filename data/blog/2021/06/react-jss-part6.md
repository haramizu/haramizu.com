...
[前回](/blog/2021/06/07/react-jss-part5) はカルーセルを作成する前に、カルーセルのアイテムを管理をするためのコンポーネントを作成しました。今回は、カルーセルのコンポーネントとなるコンテナーを作成して、前回作成したコンポーネントを子アイテムとして読み込む手順を紹介します。
...
![carousel](/static/images/2021/06/Carousel01.png "carousel")
...
![carousel](/static/images/2021/06/Carousel03.png "carousel")

続いて、placeholder の文字列を変更したいと思います。**jss-carousel-items**と変更して、再度読み込みをするとスライドが表示されない状態となります。

![carousel](/static/images/2021/06/Carousel04.png "carousel")
...
![carousel](/static/images/2021/06/Carousel05.png "carousel")
