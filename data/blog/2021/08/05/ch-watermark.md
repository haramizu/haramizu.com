...
* [動的な透かし](https://docs.stylelabs.com/ja-jp/contenthub/4.0.x/content/user-documentation/administration/processing/watermarking/overview.html?rp=true&rv=true)
...
* [新しい透かしの作成](https://docs.stylelabs.com/ja-jp/contenthub/4.0.x/content/user-documentation/administration/processing/watermarking/create-new-watermark.html?rp=true&rv=true)
* [透かしの設定](https://docs.stylelabs.com/ja-jp/contenthub/4.0.x/content/user-documentation/administration/processing/watermarking/watermark-settings.html?rp=true&rv=true)

## ウォーターマークの権限を作成

ウォーターマークの権限に関してのセットアップは以下のページに記載されています。

* [透かしのアクセス許可の設定](https://docs.stylelabs.com/ja-jp/contenthub/4.0.x/content/user-documentation/administration/processing/watermarking/set-up-watermark-permissions.html?rp=true&rv=true)
