...
Code に関しては、自分の GitHub のリポジトリを今回は指定するため、GitHub を選択します。
...
![OrderCloud](/static/images/2021/09/ordercloud52.png)
...
Clone をクリックしてStage の名前を Seller Test に変更、1 Job 1 Task をクリックをすると Stage の設定となります。ここでは、App Service name を seller の項目に変更をします。
...
![OrderCloud](/static/images/2021/09/ordercloud66.png)　
...
![OrderCloud](/static/images/2021/09/ordercloud70.png)
