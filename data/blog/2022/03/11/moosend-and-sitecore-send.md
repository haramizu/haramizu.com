...
Moosend のサービスを Sitecore ブランドで提供しているのが Sitecore Send になります。こちらのサービスはオンラインで申し込みをする形ではなく、契約をして利用してもらう企業向けのものとなります。企業向けのためオンボーディングサービスがあります。Moosend との違いは、サポートおよび将来的な Sitecore の製品との連携という点が異なってきます。
