---
title: コンポーネントの作成とテンプレート連携 - テキスト編
date: '2022-04-04'
...
images: ['/static/images/2022/04/template10.gif']
---
...
```javascript:sitecore/definitions/components/Data/TextSample.sitecore.ts
...
```javascript:src/components/Data/TextSample.tsx
