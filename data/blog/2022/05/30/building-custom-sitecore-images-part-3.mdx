...
images: ['/static/images/2022/05/customimage16.png']
---
...
<Image alt="customimage" src="/static/images/2022/05/customimage13.png" width={400} height={453} />
...
<Image alt="customimage" src="/static/images/2022/05/customimage25.png" width={400} height={322} />

コマンドラインで App_Data\localization に移動して dir コマンドを実行すると、ファイルがコピーされていることがわかります。

<Image alt="customimage" src="/static/images/2022/05/customimage26.png" width={600} height={335} />
