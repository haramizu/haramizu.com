...
これまでサンプルのアプリを利用する際には、Sitecore JSS のコマンドとして jss を利用していました。Sitecore JSS 20.0 からはコマンドの動作が更新され便利な機能が提供されるようになりました。そこで今回は、新しいテンプレートの作成方法に関して確認をしていきます。
...
![nextjs](/static/images/2022/06/nextjs11.png)

## 設定を進める

作成したフォルダに移動をします。今回は nextjs フォルダになりますので、
